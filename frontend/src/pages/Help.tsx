    ...
    questions: [
      {
        ...
        answer: 'All orders are available for pickup at the Main Campus Deli located in the TAMCC cafeteria building. Look for the "Marryshow Mealhouse" signage.',
      },
      {
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <div className="bg-white rounded-lg p-4 shadow-sm">
                ...
                <p className="text-sm text-gray-600">473-440-2000</p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
