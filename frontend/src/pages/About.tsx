  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">About Marryshow Mealhouse</h1>
      ...
      <div className="mb-16">
        <img
          src="https://images.unsplash.com/photo-1769456164543-59aac9d09256?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHw0fHxjYW1wdXMlMjBjYWZldGVyaWElMjBzdHVkZW50c3xlbnwxfHx8fDE3NzUzMTE4MDd8MA&ixlib=rb-4.1.0&q=80&w=1080"
      ...
      <div className="prose prose-lg max-w-none mb-16">
        ...
        <p className="text-gray-700 mb-4">
          Marryshow Mealhouse has been serving the TAMCC community since 2015, providing delicious,
      ...
      <div className="mb-16 bg-gradient-to-br from-blue-50 to-orange-50 rounded-lg p-8">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <div className="text-center">
            <p className="text-5xl font-bold text-[#074af2] mb-2">9</p>
        ...
        <Card className="bg-[#074af2] text-white">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-lg mb-6 max-w-2xl mx-auto">
              We're always looking for passionate individuals to join the Marryshow Mealhouse family.
              If you love food and serving others, we'd love to hear from you!
            </p>
            <button className="bg-white text-[#074af2] px-8 py-3 rounded-lg font-medium hover:bg-gray-100 transition-colors">
              View Job Openings
            </button>
          </CardContent>
        </Card>
