              ...
              <TableBody>
                {filteredOrders.map((order) => (
                  <TableRow key={order.id}>
                    ...
                    <TableCell><div><p className="font-medium">{order.customer}</p><p className="text-sm text-gray-500">{order.email}</p></div></TableCell>
                    ...
                    <TableCell>
                      <Button size="sm" variant="ghost" onClick={() => window.location.href = `/admin/orders/${order.id}`}>
