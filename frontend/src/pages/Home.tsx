...
const campusImage = 'https://images.unsplash.com/photo-1641772094405-6a7db15e8291?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb2xsZWdlJTIwY2FtcHVzJTIwc3R1ZGVudHMlMjBidWlsZGluZ3xlbnwxfHx8fDE3NzQ1NjgyMTR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral';
...
export function Landing() {
  ...
  useEffect(() => {
    itemsService.getItems().then(items => setPopularItems(items.slice(0, 3)));
  }, []);
  ...
  return (
    <div>
      ...
      <section className="relative h-[500px] bg-gray-900">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#074af2]/80 to-[#f97316]/60" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-white max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Welcome to Marryshow Mealhouse
            </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-4">About Marryshow Mealhouse</h2>
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
              <div>
                ...
                <p className="text-lg">7:00 AM - 6:00 PM</p>
              </div>
              <div>
                <h3 className="font-bold mb-2 text-[#f97316]">Weekends</h3>
                <p className="text-white/90">Saturday</p>
                <p className="text-lg">8:00 AM - 2:00 PM</p>
                <p className="text-sm text-white/70 mt-2">Closed Sunday</p>
              </div>
            </div>
          </div>
        </div>
